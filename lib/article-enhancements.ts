...
const articleEnhancements:Record<string,ArticleEnhancement>={
  ...
  'karna-mahabharata-story-text-popular-retellings':{
    ...
    faq:[
      {question:'Was Karna born with kavach and kundal?',answer:'Yes. Vana Parva, Section CCCVI (306) in K. M. Ganguli’s translation describes Karna as born with kavach and kundal. They were present from birth, before his upbringing with Adhiratha and Radha.'},
      {question:'Why was Karna born with kavach and kundal?',answer:'Kunti asks Surya for a son with kavach and kundal, and Surya agrees. Vana Parva, Section CCCV (305) in K. M. Ganguli’s translation describes them as made of amrita and the kavach as invulnerable. They are divine protection granted at birth.'},
